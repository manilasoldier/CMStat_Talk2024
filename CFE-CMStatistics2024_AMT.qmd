...
- To assess the dynamics of the 36-dimensional time series, we use `bclr`: available at <a href="https://github.com/manilasoldier/bclr">https://github.com/manilasoldier/bclr</a>

- Companion package to "Bayesian changepoint detection via logistic regression and the topological analysis of image series" (Thomas, Jauch, and Matteson, 2024)
...
<p style="font-size: 24px;"> Histogram equalized version of deep-denoised nanoparticle video. Video was denoised according "Unsupervised Deep Video Denoised" as in Crozier et. al (2024). </p>
...
We can use the so-called ALPS statistic (Thomas et. al, 2024) to summarize the trajectory of changepoints we inferred from the noisy video. 
...
<b>Atomic resolution observations of nanoparticle surface dynamics and instabilities enabled by artificial intelligence</b> <br>
Peter A. Crozier, Matan Leibovich, Piyush Haluai, Mai Tan, <b style="color: gray;">Andrew M. Thomas</b>, Joshua Vincent, David M. Matteson, <br> Yifan Wang, and Carlos Fernandez-Granda. <br>
<i style="font-style: italic;">arXiv preprint</i>. <a href="https://arxiv.org/abs/2407.17669">arXiv:2407.17669</a>, (2024).
...
<i style="font-style: italic;">arXiv preprint</i>. <a href="https://arxiv.org/abs/2401.02917">arXiv:2401.02917</a>, (2024). <br>
